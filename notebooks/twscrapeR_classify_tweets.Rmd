...
# Obtener las comunidades más relevantes
top_communities <- names(sort(table(datos_gephi$modularity_class), decreasing = TRUE)[1:params$max_communities])

# Filtrar el dataframe
datos_gephi <- datos_gephi[datos_gephi$modularity_class %in% top_communities, ]
